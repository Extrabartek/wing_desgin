...
WP41.cr = planform.cr
WP41.ct = planform.ct
WP41.q = fn.load_factor * fn.g * (weight_final/2 + integrate.quad(lambda a: wingbox.mass_distribution(planform, a), 0, planform.b/2)[0])/(integrate.quad(lambda a: WP41.c(a) * ((fn.AoA == 0) * WP41.cly1(a) + (fn.AoA == 10) * WP41.cly2(a)), 0, planform.b/2)[0])
print(WP41.q)
